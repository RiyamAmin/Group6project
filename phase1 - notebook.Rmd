...
level_factor <- factor(data$Level, ordered = TRUE)
...
# Correlation of Level  and age attributes is positive and above 0.7, hence, the attributes are strongly correlated.


cor(level_factor, data$Gender)
# There is a negative correlation between the gender of the patients and the Level of lung cancer, so these variables are independent. 
